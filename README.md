# 🌍 NeoAus 国家社会模拟服务器
无论怎么样，至少创始人Aus再也回不来了(悲)

欢迎来到 **新奥斯汀大陆**！这是一个结合 **社会模拟 + 技术工业 + 战争政治** 的 Minecraft 高自由度服务器。
- (好吧，至少国家模拟是这个服务器的特色，完全可以当成正常服游玩，但是国家和城镇命名严禁涉政，不能包含现实领导人信息）
- 不管你是热爱经营建设、只专心搞科研发展、还是单纯想参与战争围攻，这里都能满足你的玩法！
...
- **服务器 IP**：[12月15日敬请期待](http://eco.aus.xo.je:26343)  
- **官方 QQ 群**：836536388  
- **制作人**：Aus（已跑路）
- 运营者:Duch
...
Aus 使用经典插件 **Towny Advanced** 实现城邦与国家模拟。
...
**KingdomsX** 是一个帮派式势力插件，用于参与大规模冲突与“派系战争”。
...
- 警告：KingdomsX 与 Towny 不完全兼容，但也互不干扰：它更偏向冲突与资源争夺。
- 可以在 Towny 国家中发展 Kingdom 派系，也可以开始就完全独立于城邦建立野蛮势力。
...
📍 访问地址：[12月15日敬请期待](http://eco.aus.xo.je:25611)
...
在 **新奥斯汀大陆** 中，战争是一个主要核心机制，帮助玩家之间建立复杂的政治结构和军事冲突。
当然，你也可以不寻求建立国家和城邦，在混乱里始终中立为自由民
...
2. **帮派势力**（KingdomsX）：以帮派为主，玩家可创建帮派、进行资源争夺与扩张。

### 【2】战争触发规则
- **KingdomsX 势力** 需要建立至少一个核心城镇作为根据地，才能发动战争。
- **Towny 城邦** 必须通过领导授权或投票程序才可批准开战，不能随意挑起战争。
...
- 战败方城镇将进入 **现实72小时的休战期**，在此期间不能被再次攻击。
- 防守方有 **现实72小时** 的时间重新组织力量反击。
...
- **国家历史博物馆**：可设置游戏内历史博物馆，记录每场战争的结果、胜负方、被吞并的城镇历史等。（大饼，暂未时装）
...
| `/nation enemy add <国家名>` | 标记目标 Towny 国家为敌国（无实际战争功能，仅政治宣示以及未来使用攻城战） |
